...
The pipeline was evaluated using Adjusted Mutual Information (AMI) scores & ended up scoring the highest in class, while also beating the previous cohort's best score (nickname: oceanman🙂)
