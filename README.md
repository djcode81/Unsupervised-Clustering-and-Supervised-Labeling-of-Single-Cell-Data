...
The pipeline was evaluated using Adjusted Mutual Information (AMI) scores and ended up scoring the highest in [class](https://bits.csb.pitt.edu/cobb2060/assign3/) (nickname: oceanman🙂)
